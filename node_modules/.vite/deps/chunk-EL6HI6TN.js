...
function getWeekArray(date2, locale, firstDayOfWeek) {
  ...
  const first = (_b = firstDayOfWeek != null ? firstDayOfWeek : (_a = weekInfo(locale)) == null ? void 0 : _a.firstDay) != null ? _b : 0;
...
function startOfWeek(date2, locale, firstDayOfWeek) {
  var _a, _b;
  const day = (_b = firstDayOfWeek != null ? firstDayOfWeek : (_a = weekInfo(locale)) == null ? void 0 : _a.firstDay) != null ? _b : 0;
...
function endOfWeek(date2, locale) {
  var _a, _b;
  const d = new Date(date2);
  const lastDay = (((_b = (_a = weekInfo(locale)) == null ? void 0 : _a.firstDay) != null ? _b : 0) + 6) % 7;
...
function getWeekdays(locale, firstDayOfWeek, weekdayFormat) {
  var _a, _b;
  const daysFromSunday = (_b = firstDayOfWeek != null ? firstDayOfWeek : (_a = weekInfo(locale)) == null ? void 0 : _a.firstDay) != null ? _b : 0;
  return createRange(7).map((i) => {
    const weekday = new Date(sundayJanuarySecond2000);
    weekday.setDate(sundayJanuarySecond2000.getDate() + daysFromSunday + i);
    return new Intl.DateTimeFormat(locale, {
      weekday: weekdayFormat != null ? weekdayFormat : "narrow"
    }).format(weekday);
  });
}
...
function getWeek(date2, locale, firstDayOfWeek, firstWeekMinSize) {
  ...
  const weekStart = (_a = firstDayOfWeek != null ? firstDayOfWeek : weekInfoFromLocale == null ? void 0 : weekInfoFromLocale.firstDay) != null ? _a : 0;
...
function createDateRange(adapter, start, stop) {
  const diff = adapter.getDiff(adapter.endOfDay(stop != null ? stop : start), adapter.startOfDay(start), "days");
...
function useHotkey(keys, callback) {
  ...
  const isMac = (_b = (_a = navigator == null ? void 0 : navigator.userAgent) == null ? void 0 : _a.includes("Macintosh")) != null ? _b : false;
  let timeout = 0;
  let keyGroups;
...
//# sourceMappingURL=chunk-EL6HI6TN.js.map
