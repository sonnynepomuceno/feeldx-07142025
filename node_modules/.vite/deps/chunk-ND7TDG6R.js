...
function renderSlot(slot, props, fallback) {
  var _a;
  return (_a = slot == null ? void 0 : slot(props)) != null ? _a : fallback == null ? void 0 : fallback(props);
}
...
function parseColor(color) {
  if (typeof color === "number") {
    ...
    const realValues = values.split(/,\s*|\s*\/\s*|\s+/).map((v, i) => {
      if (v.endsWith("%") || i > 0 && i < 3 && ["hsl", "hsla", "hsv", "hsva"].includes(fn)) {
...
function createVuetifyAdapter(options) {
  ...
  return {
    ...
    fallback,
    messages,
    decimalSeparator: toRef(() => {
      var _a2;
      return (_a2 = options == null ? void 0 : options.decimalSeparator) != null ? _a2 : inferDecimalSeparator(current, fallback);
    }),
    t: createTranslateFunction(current, fallback, messages),
    n: createNumberFunction(current, fallback),
    provide: createProvideFunction({
...
function genCssVariables(theme, prefix) {
  ...
  for (const [key, value] of Object.entries(theme.variables)) {
    ...
    variables.push(`--${prefix}${key}: ${rgb != null ? rgb : value}`);
  }
  return variables;
}
...
//# sourceMappingURL=chunk-ND7TDG6R.js.map
